...
### 4. Поле логотипа (текстовое поле для URL)

- Используется для отображения логотипов команд
- **Тип:** `text` (текстовое поле)
- **Значение:** URL логотипа в формате PNG с мобильного HTTP сервера
...
- Пример: `http://192.168.1.100:3000/logos/logo_a.png`
...
3. **teamALogo** - Лого команды А (URL, текст)
4. **teamAName** - Название команды А (текст)
5. **teamACity** - Город команды А (текст)
6. **teamBLogo** - Лого команды Б (URL, текст)
