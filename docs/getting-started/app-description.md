...
### 2.1. Данные приложения и переустановка

- Настройки, сохранённые матчи и логотипы хранятся в папке данных приложения (userData) и **сохраняются при переустановке** на той же машине — не нужно заново настраивать vMix или импортировать матчи после обновления или переустановки.
- Подробнее о путях и хранении данных см. [Архитектура](../architecture/ARCHITECTURE.md) (раздел «Сохранение данных при переустановке»).

### 2.2. Импорт и экспорт настроек
