...
│  Цвет формы либеро: [пикер] [#hex или пусто]   │
│                                                 │
│  Состав команды: [Импорт] [Экспорт] [Добавить] │
...
- **Внешний вид команды:** название, логотип (загрузка/удаление), цвет формы игроков, цвет формы либеро
