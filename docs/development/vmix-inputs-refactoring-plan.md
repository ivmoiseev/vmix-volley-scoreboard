...
**Выполнение (2026-02-04):** Этапы 1–5, 7–8 реализованы или частично реализованы; этап 6 (раскрывающиеся блоки полей и сопоставление) оставлен на следующую итерацию. Отметки по каждому этапу см. в инструкции по реализации.
