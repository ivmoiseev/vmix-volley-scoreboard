...
**План переработки:** См. [vmix-settings-redesign-plan.md](./vmix-settings-redesign-plan.md) - детальный план улучшения страницы настроек с системой вкладок, детальной настройкой полей инпутов, поддержкой различных типов полей (текст, цвет, видимость, логотипы) и гибкой конфигурацией.
