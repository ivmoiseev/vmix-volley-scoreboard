...
function getDefaultFieldsForInput(inputKey) {
  const configs = {
    currentScore: {
      ...
      pointA: { enabled: true, type: 'visibility', fieldName: 'Поинт А', fieldIdentifier: 'PointA' },
      pointB: { enabled: true, type: 'visibility', fieldName: 'Поинт Б', fieldIdentifier: 'PointB' },
      colorA: { enabled: true, type: 'color', fieldName: 'Цвет А', fieldIdentifier: 'ColorA' },
      colorB: { enabled: true, type: 'color', fieldName: 'Цвет Б', fieldIdentifier: 'ColorB' },
    },
    ...
    rosterTeamA: {
      ...
      player7NumberOnCard: { enabled: true, type: 'text', fieldName: 'Номер игрока 7 на карте', fieldIdentifier: 'Player7NumberOnCard' },
      ...
      player8NumberOnCard: { enabled: true, type: 'text', fieldName: 'Номер игрока 8 на карте', fieldIdentifier: 'Player8NumberOnCard' },
